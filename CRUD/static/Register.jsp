...
<ul class="nav nav-tabs" id="myTab" role="tablist">
    ...
    <li class="nav-item" role="presentation">
        <button class="nav-link" id="profile-tab" type="button" ><a href="RegisterForm">Register</a></button>
    </li>
    <li class="nav-item" role="presentation">
    ...
    <h1>Registration Form</h1>  <span style="color:red">${error}</span>
    <form action="RegisterForm" class="row g-3 needs-validation" method="post" novalidate>
